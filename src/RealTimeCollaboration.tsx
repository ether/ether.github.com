...
export const RealTimeCollaboration = ()=>{
    return <div className="content wrap">
        ...
        <p>All instances provide access to all data through a well-documented API and support import/export to many
        ...
        <p>You don't need to set up a server and install Etherpad in order to use it. Just <a href="#links">pick</a> one
